...
public class Config {
    ...
    //阅读解压路径
    public static final String UNZIP_READING_FILE_PATH = Environment.getExternalStorageDirectory()
            .getAbsolutePath() + File.separator + "GraduateEnglish"+ File.separator + "reading";
